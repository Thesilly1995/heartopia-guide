...
const TIP_CATEGORIES_RAW: TipCategoryRaw[] = [
  {
    ...
    tips: [
      ...
      },
      {
        ...
        titleEs: 'El mineral de meteoro sigue siendo minable por un tiempo',
        titlePt: 'O minério de meteoro continua minerável por um tempo',
        ...
        bodyEs: 'Después de una lluvia de meteoros, los trozos de mineral siguen siendo minables durante 24 horas desde que empieza la lluvia — no tienes que hacerlo todo esa misma noche.',
        bodyPt: 'Depois de uma chuva de meteoros, os pedaços de minério continuam mineráveis por 24 horas após o início da chuva — você não precisa terminar tudo naquela mesma noite.',
        emoji: '☄️',
      },
      {
