...
const WILD_ANIMALS_RAW: WildAnimalRaw[] = [
  ...
  { nameNl: "Pinguïn", nameEn: "Penguin", weatherNl: "Sneeuw", weatherEn: "Snowy", foodsNl: ["Gewone Garnaal","Valse Horsmakreel","Sardine"], foodsEn: ["Common Prawn","False Scad","Sardine"], spotNl: "Onsen Berg, ten oosten van Frostspore (alleen Winter Frost Season)", spotEn: "Onsen Mountain, east of Frostspore (Winter Frost Season only)", noteNl: null, noteEn: null, emoji: "🐧" },
