...
const WILD_ANIMALS_RAW: WildAnimalRaw[] = [
  ...
  { nameNl: "Dolfijn", nameEn: "Dolphin", weatherNl: "Zonnig", weatherEn: "Sunny", foodsNl: ["Sardine","Zeebaars","Horsmakreel"], foodsEn: ["Sardine","Sea Bass","Scad"], spotNl: "Whalefall Canyon, dolfijnentrog ten zuiden van de Whalefall", spotEn: "Whalefall Canyon, dolphin trough south of the Whalefall", noteNl: "Tijdelijk dier van een afgelopen event (Call of Whales, geëindigd 22 augustus 2026) — kan momenteel niet meer gevoerd worden. Kan mogelijk terugkeren in een volgend event — vriendschap blijft daarom bijhoudbaar", noteEn: "Temporary animal from a past event (Call of Whales, ended Aug 22, 2026) — can no longer be fed right now. May return in a future event — friendship stays trackable for that reason", emoji: "🐬" },
