...
const RECIPES_RAW: RecipeRaw[] = [
  ...
  { nameNl: "Appel Milkshake", nameEn: "Apple Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Appel ×2"], ingredientsEn: ["Milk x2","Apples x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [450,675,900,1800,3600] },
  { nameNl: "Bosbes Milkshake", nameEn: "Blueberry Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Bosbes ×2"], ingredientsEn: ["Milk x2","Blueberries x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [400,600,800,1600,3200] },
  { nameNl: "Cacao Melkthee", nameEn: "Cocoa Milk Tea", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Zwarte Thee ×2","Melk","Cacaobonen"], ingredientsEn: ["Black Tea x2","Milk","Cocoa Beans"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🍵", sellPriceByStar: [1120,1680,2240,4480,8960] },
  { nameNl: "Cacao Milkshake", nameEn: "Cocoa Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Cacaobonen ×2"], ingredientsEn: ["Milk x2","Cocoa Beans x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [1000,1500,2000,4000,8000] },
  { nameNl: "Fruitige Zwarte Thee", nameEn: "Fruity Black Tea", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Zwarte Thee ×2","Zwarte Thee/Melk/Cacaobonen ×2"], ingredientsEn: ["Black Tea x2","Black Tea/Milk/Cocoa Beans x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🍵", sellPriceByStar: [840,1260,1680,3360,6720] },
  { nameNl: "Druiven Milkshake", nameEn: "Grape Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Druif ×2"], ingredientsEn: ["Milk x2","Grapes x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [1300,1950,2600,5200,10400] },
  { nameNl: "Matcha Milkshake", nameEn: "Matcha Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Matcha Poeder ×2"], ingredientsEn: ["Milk x2","Matcha Powder x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [840,1260,1680,3360,6720] },
  { nameNl: "Milkshake", nameEn: "Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Melk/Fruit (willekeurig) ×2"], ingredientsEn: ["Milk x2","Milk/Any Fruit x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [400,600,800,1600,3200] },
  { nameNl: "Sinaasappel Milkshake", nameEn: "Orange Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Sinaasappel ×2"], ingredientsEn: ["Milk x2","Orange x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [450,675,900,1800,3600] },
  { nameNl: "Ananas Milkshake", nameEn: "Pineapple Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Ananas ×2"], ingredientsEn: ["Milk x2","Pineapple x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [440,660,880,1760,3520] },
  { nameNl: "Romige Melkthee", nameEn: "Rich Milk Tea", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Zwarte Thee ×2","Melk ×2"], ingredientsEn: ["Black Tea x2","Milk x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🍵", sellPriceByStar: [840,1260,1680,3360,6720] },
  { nameNl: "Aardbei Milkshake", nameEn: "Strawberry Milkshake", rarityNl: "Legendarisch", rarityEn: "Legendary", toolNl: "Fornuis", toolEn: "Stove", ingredientsNl: ["Melk ×2","Aardbei ×2"], ingredientsEn: ["Milk x2","Strawberries x2"], level: 11, rarityColorKey: "yellow", xp: 65, emoji: "🥤", sellPriceByStar: [440,660,880,1760,3520] },
