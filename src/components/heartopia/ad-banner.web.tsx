...
/**
 * Mock advertentiebanner voor web — AdMob heeft geen web-implementatie, dus hier
 * blijft de placeholder staan (zie ad-banner.tsx voor de echte iOS/Android-banner).
 * Puur UI: laat zien hoe "premium = reclamevrij" aanvoelt tijdens web-preview/tests.
 */
