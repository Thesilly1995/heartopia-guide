...
const STRINGS = {
  ...
  es: {
    title: 'Cloud Save',
    subtitle: 'Guarda tu progreso y úsalo en otro dispositivo',
    lockedText: 'Cloud save guarda tu progreso (mastery, estrellas, misiones, tareas, feedback) en línea, para que puedas restaurarlo en otro dispositivo.',
    notConfiguredTitle: 'Cloud save todavía se está configurando',
    notConfiguredText: 'El backend (Supabase) aún no está conectado a la app — esta pantalla funcionará en cuanto esté listo.',
    emailPlaceholder: 'Correo electrónico',
    passwordPlaceholder: 'Contraseña (mín. 6 caracteres)',
    signIn: 'Iniciar sesión',
    signUp: 'Crear cuenta',
    toggleToSignUp: '¿Todavía no tienes cuenta? Crea una',
    toggleToSignIn: '¿Ya tienes cuenta? Inicia sesión',
    working: 'Procesando...',
    loggedInAs: 'Conectado como',
    signOut: 'Cerrar sesión',
    backupButton: 'Hacer copia de seguridad ahora',
    restoreButton: 'Restaurar desde la nube',
    backupDone: (n: number) => `✓ ${n} elementos guardados en la nube`,
    restoreDone: (n: number) => `✓ ${n} elementos restaurados desde la nube`,
    restoreEmpty: 'Todavía no se ha encontrado ninguna copia de seguridad para esta cuenta.',
    restoreConfirmTitle: '¿Restaurar progreso?',
    restoreConfirmText: 'Esto sobrescribirá el progreso de este dispositivo con la última copia de seguridad en la nube. ¿Estás seguro?',
    cancel: 'Cancelar',
    confirm: 'Restaurar',
  },
  pt: {
    title: 'Cloud Save',
    subtitle: 'Salve seu progresso e use-o em outro aparelho',
    lockedText: 'O cloud save guarda seu progresso (mastery, estrelas, missões, tarefas, feedback) online, para que você possa restaurá-lo em outro aparelho.',
    notConfiguredTitle: 'O cloud save ainda está sendo configurado',
    notConfiguredText: 'O backend (Supabase) ainda não está conectado ao app — esta tela vai funcionar assim que estiver pronto.',
    emailPlaceholder: 'Endereço de e-mail',
    passwordPlaceholder: 'Senha (mín. 6 caracteres)',
    signIn: 'Entrar',
    signUp: 'Criar conta',
    toggleToSignUp: 'Ainda não tem conta? Crie uma',
    toggleToSignIn: 'Já tem conta? Entrar',
    working: 'Processando...',
    loggedInAs: 'Conectado como',
    signOut: 'Sair',
    backupButton: 'Fazer backup na nuvem agora',
    restoreButton: 'Restaurar da nuvem',
    backupDone: (n: number) => `✓ ${n} itens salvos na nuvem`,
    restoreDone: (n: number) => `✓ ${n} itens restaurados da nuvem`,
    restoreEmpty: 'Ainda não foi encontrado nenhum backup para esta conta.',
    restoreConfirmTitle: 'Restaurar progresso?',
    restoreConfirmText: 'Isso vai substituir o progresso deste aparelho pelo último backup na nuvem. Tem certeza?',
    cancel: 'Cancelar',
    confirm: 'Restaurar',
  },
  fr: {
    title: 'Cloud Save',
    subtitle: 'Sauvegarde ta progression et utilise-la sur un autre appareil',
    lockedText: 'Cloud save enregistre ta progression (mastery, étoiles, missions, to-do, feedback) en ligne, pour que tu puisses la restaurer sur un autre appareil.',
    notConfiguredTitle: 'Cloud save est encore en cours de mise en place',
    notConfiguredText: "Le backend (Supabase) n'est pas encore connecté à l'app — cet écran fonctionnera dès que ce sera prêt.",
    emailPlaceholder: 'Adresse e-mail',
    passwordPlaceholder: 'Mot de passe (min. 6 caractères)',
    signIn: 'Se connecter',
    signUp: 'Créer un compte',
    toggleToSignUp: "Pas encore de compte ? Crée-en un",
    toggleToSignIn: 'Déjà un compte ? Connecte-toi',
    working: 'En cours...',
    loggedInAs: 'Connecté en tant que',
    signOut: 'Se déconnecter',
    backupButton: 'Sauvegarder dans le cloud maintenant',
    restoreButton: 'Restaurer depuis le cloud',
    backupDone: (n: number) => `✓ ${n} éléments enregistrés dans le cloud`,
    restoreDone: (n: number) => `✓ ${n} éléments restaurés depuis le cloud`,
    restoreEmpty: 'Aucune sauvegarde trouvée pour ce compte pour le moment.',
    restoreConfirmTitle: 'Restaurer la progression ?',
    restoreConfirmText: "Cela remplace la progression sur cet appareil par la dernière sauvegarde cloud. Tu es sûr(e) ?",
    cancel: 'Annuler',
    confirm: 'Restaurer',
  },
  de: {
    title: 'Cloud Save',
    subtitle: 'Sichere deinen Fortschritt & nutze ihn auf einem anderen Gerät',
    lockedText: 'Cloud Save speichert deinen Fortschritt (Mastery, Sterne, Missionen, To-do, Feedback) online, damit du ihn auf einem anderen Gerät wiederherstellen kannst.',
    notConfiguredTitle: 'Cloud Save wird noch eingerichtet',
    notConfiguredText: 'Das Backend (Supabase) ist noch nicht mit der App verbunden — dieser Bildschirm funktioniert, sobald das fertig ist.',
    emailPlaceholder: 'E-Mail-Adresse',
    passwordPlaceholder: 'Passwort (mind. 6 Zeichen)',
    signIn: 'Anmelden',
    signUp: 'Konto erstellen',
    toggleToSignUp: 'Noch kein Konto? Erstelle eins',
    toggleToSignIn: 'Schon ein Konto? Melde dich an',
    working: 'Einen Moment...',
    loggedInAs: 'Angemeldet als',
    signOut: 'Abmelden',
    backupButton: 'Jetzt in der Cloud sichern',
    restoreButton: 'Aus der Cloud wiederherstellen',
    backupDone: (n: number) => `✓ ${n} Elemente in der Cloud gespeichert`,
    restoreDone: (n: number) => `✓ ${n} Elemente aus der Cloud wiederhergestellt`,
    restoreEmpty: 'Für dieses Konto wurde noch kein Backup gefunden.',
    restoreConfirmTitle: 'Fortschritt wiederherstellen?',
    restoreConfirmText: 'Dadurch wird der Fortschritt auf diesem Gerät mit dem neuesten Cloud-Backup überschrieben. Bist du sicher?',
    cancel: 'Abbrechen',
