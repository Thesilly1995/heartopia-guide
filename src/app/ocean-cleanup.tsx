...
const STRINGS = {
  nl: {
    ...
    shellCatalogDesc: '26 van de 30 bekende schelpen (bron: eigen screenshots + community-tracker)',
    filterAll: 'Alle',
  ...
  en: {
    ...
    shellCatalogDesc: '26 of the 30 known shells (source: own screenshots + community tracker)',
    filterAll: 'All',
