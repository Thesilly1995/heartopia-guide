...
const TITLE = { nl: 'Beeldhouwen', en: 'Sculpting', es: 'Escultura', pt: 'Escultura', fr: 'Sculpture' };
const SAND_LABEL = { nl: 'Zand', en: 'Sand', es: 'Arena', pt: 'Areia', fr: 'Sable' };
const SNOW_LABEL = { nl: 'Sneeuw', en: 'Snow', es: 'Nieve', pt: 'Neve', fr: 'Neige' };
