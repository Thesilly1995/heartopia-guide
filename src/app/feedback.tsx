...
const STRINGS = {
  ...
  es: {
    title: 'Comentarios',
    subtitle: 'Comparte tus ideas para la guía',
    disclaimer: 'Estos comentarios se comparten — cualquiera que abra la app puede ver la lista, no se necesita cuenta.',
    notConfigured: 'Los comentarios todavía no están disponibles — el backend aún se está configurando.',
    namePlaceholder: 'Tu nombre (opcional)',
    ideaPlaceholder: '¿Qué te gustaría añadir o cambiar?',
    saving: 'Enviando...',
    done: '¡Gracias! ✓',
    submit: 'Enviar',
    error: 'Error al enviar — inténtalo de nuevo más tarde.',
    loadError: 'Error al cargar — inténtalo de nuevo más tarde.',
    recent: 'Ideas añadidas anteriormente — quitamos los comentarios de la lista una vez atendidos, así que si tu idea ya no aparece, ¡significa que se ha resuelto! ✓',
    empty: 'Todavía no hay comentarios — ¡añade el primero!',
    anonymous: 'Anónimo',
    adminLink: 'Administrador',
    adminLockLink: '🔒 Bloquear',
    adminPrompt: 'Introduce el código para poder eliminar comentarios.',
    adminCodePlaceholder: 'Código de administrador',
    adminUnlock: 'Desbloquear',
    adminWrongCode: 'Código incorrecto.',
    deleteConfirmText: 'Esto eliminará esta idea de forma permanente de la lista compartida.',
  ...
  pt: {
    title: 'Feedback',
    subtitle: 'Compartilhe suas ideias para o guia',
    disclaimer: 'Este feedback é compartilhado — qualquer pessoa que abrir o app pode ver a lista, sem necessidade de conta.',
    notConfigured: 'O feedback ainda não está disponível — o backend ainda está sendo configurado.',
    namePlaceholder: 'Seu nome (opcional)',
    ideaPlaceholder: 'O que você gostaria de adicionar ou mudar?',
    saving: 'Enviando...',
    done: 'Obrigado! ✓',
    submit: 'Enviar',
    error: 'Falha ao enviar — tente novamente mais tarde.',
    loadError: 'Falha ao carregar — tente novamente mais tarde.',
    recent: 'Ideias adicionadas anteriormente — removemos o feedback assim que é resolvido, então se sua ideia não estiver mais na lista, ela já foi tratada! ✓',
    empty: 'Ainda não há feedback — adicione o primeiro!',
    anonymous: 'Anônimo',
    adminLink: 'Administrador',
    adminLockLink: '🔒 Bloquear',
    adminPrompt: 'Digite o código para poder excluir feedback.',
    adminCodePlaceholder: 'Código de administrador',
    adminUnlock: 'Desbloquear',
    adminWrongCode: 'Código incorreto.',
    deleteConfirmText: 'Isso removerá esta ideia permanentemente da lista compartilhada.',
  ...
  fr: {
    title: 'Retours',
    subtitle: 'Partage tes idées pour le guide',
    disclaimer: "Ces retours sont partagés — tout le monde qui ouvre l'app peut voir la liste, aucun compte nécessaire.",
    notConfigured: "Les retours ne sont pas encore disponibles — le backend est encore en cours de configuration.",
    namePlaceholder: 'Ton nom (facultatif)',
    ideaPlaceholder: 'Qu\'aimerais-tu ajouter ou changer ?',
    saving: 'Envoi en cours...',
    done: 'Merci ! ✓',
    submit: 'Envoyer',
    error: "L'envoi a échoué — réessaie plus tard.",
    loadError: 'Le chargement a échoué — réessaie plus tard.',
    recent: "Idées ajoutées précédemment — on retire les retours de la liste une fois traités, donc si ton idée n'y est plus, c'est qu'elle a été prise en compte ! ✓",
    empty: "Pas encore de retours — ajoute le premier !",
    anonymous: 'Anonyme',
    adminLink: 'Administrateur',
    adminLockLink: '🔒 Verrouiller',
    adminPrompt: 'Entre le code pour pouvoir supprimer des retours.',
    adminCodePlaceholder: 'Code administrateur',
    adminUnlock: 'Déverrouiller',
    adminWrongCode: 'Code incorrect.',
    deleteConfirmText: 'Cela retirera définitivement cette idée de la liste partagée.',
  ...
  de: {
    title: 'Feedback',
    subtitle: 'Teile deine Ideen für den Guide',
    disclaimer: 'Dieses Feedback wird geteilt — jeder, der die App öffnet, kann die Liste sehen, kein Account nötig.',
    notConfigured: 'Feedback ist noch nicht verfügbar — das Backend wird noch eingerichtet.',
    namePlaceholder: 'Dein Name (optional)',
    ideaPlaceholder: 'Was möchtest du hinzufügen oder geändert sehen?',
    saving: 'Wird gesendet...',
    done: 'Danke! ✓',
    submit: 'Senden',
    error: 'Senden fehlgeschlagen — versuch es später noch einmal.',
    loadError: 'Laden fehlgeschlagen — versuch es später noch einmal.',
    recent: 'Bereits hinzugefügte Ideen — bearbeitetes Feedback entfernen wir von der Liste, steht deine Idee also nicht mehr da? Dann wurde sie umgesetzt! ✓',
    empty: 'Noch kein Feedback — füge das erste hinzu!',
    anonymous: 'Anonym',
    adminLink: 'Administrator',
    adminLockLink: '🔒 Sperren',
    adminPrompt: 'Gib den Code ein, um Feedback löschen zu können.',
    adminCodePlaceholder: 'Administrator-Code',
    adminUnlock: 'Entsperren',
    adminWrongCode: 'Falscher Code.',
    deleteConfirmText: 'Dadurch wird diese Idee endgültig von der geteilten Liste entfernt.',
    deleteConfirm: 'Löschen',
    cancel: 'Abbrechen',
    deleteError: 'Löschen fehlgeschlagen — versuch es noch einmal.',
  },
} as const;
